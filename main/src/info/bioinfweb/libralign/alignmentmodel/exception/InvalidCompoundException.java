 ...
 */
package info.bioinfweb.libralign.alignmentmodel.exception;
 ...
 * match the data type of the provider (e.g. trying to write an amino acid to a nucleotide data source). 
 * 
 * @author Ben St&ouml;ver
 * @since 0.0.0
 */
public class InvalidCompoundException extends AlignmentModelException {
