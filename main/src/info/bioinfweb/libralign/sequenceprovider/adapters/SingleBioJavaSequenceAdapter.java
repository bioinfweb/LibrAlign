 ...
 * to view one sequence of a {@link SequenceDataProvider} as a BioJava {@link Sequence} object. 
 * <p>
...
public class SingleBioJavaSequenceAdapter<T, C extends Compound> 
  ...
  //TODO Add constants for codons and amino acids
	 ...
	 */
	public SingleBioJavaSequenceAdapter(SequenceDataProvider<T> underlyingProvider, int sequenceID, int offset,
	 ...
	 * @param compoundSet - the compound set to be used for the translation
	 */
	public SingleBioJavaSequenceAdapter(SequenceDataProvider<T> underlyingProvider, int sequenceID, 
	...
	/**
	 * This method always returns null since sequences stored in instances of {@link SequenceDataProvider}
