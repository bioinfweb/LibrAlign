 ...
 * @since 0.4.0
 */
public interface ConcatenatedAlignmentModel extends SequenceDataProvider<Object> {
	/**
	 ...
	 */
	public void insertPartModel(int modelIndex, SequenceDataProvider<?> model);
	 ...
	 * @throws IndexOutOfBoundsException if {@code index} is below 0 or >= {@link #getPartModelCount()}
	 */
	public SequenceDataProvider<?> getPartModel(int index);
	 ...
	 */
	public SequenceDataProvider<?> getLastPartModel();
	 ...
	 */
	public SequenceDataProvider<?> partModelByColumn(int columnIndex);
