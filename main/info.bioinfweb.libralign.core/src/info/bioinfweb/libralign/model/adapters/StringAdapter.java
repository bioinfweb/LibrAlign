...
public class StringAdapter<T> extends CharSequenceAdapter<T> {
   ...
   */
	public StringAdapter(AlignmentModel<T> underlyingProvider, boolean cutLongRepresentations) {
	 ...
	 */
	@Override
	public String getSubSequence(String sequenceID, int offset, int length) {
